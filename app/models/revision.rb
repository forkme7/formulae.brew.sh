...
class Revision
  ...
  has_and_belongs_to_many :added_formulae, class_name: 'Formula',
                                           inverse_of: nil, validate: false
  has_and_belongs_to_many :updated_formulae, class_name: 'Formula',
                                             inverse_of: nil, validate: false
  has_and_belongs_to_many :removed_formulae, class_name: 'Formula',
                                             inverse_of: nil, validate: false
